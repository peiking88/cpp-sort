...
TEST_CASE( "parallel_quick_sorter tests", "[parallel_quick_sorter]" )
{
    ...
    SECTION( "small dataset: sort with random-access range" )
    {
        ...
        cppsort::parallel_quick_sort(vec);
    ...
    SECTION( "small dataset: sort with random-access range and compare" )
    {
        ...
        cppsort::parallel_quick_sort(vec, std::greater{});
    ...
    SECTION( "small dataset: sort with random-access iterators" )
    {
        ...
        cppsort::parallel_quick_sort(vec.begin(), vec.end());
        CHECK( std::is_sorted(vec.begin(), vec.end()) );
    }
    ...
    SECTION( "small dataset: sort with random-access iterators and compare" )
    {
        ...
        cppsort::parallel_quick_sort(vec.begin(), vec.end(), std::greater{});
        CHECK( std::is_sorted(vec.begin(), vec.end(), std::greater{}) );
    }
...
TEST_CASE( "parallel_quick_sorter large dataset tests", "[parallel_quick_sorter][large]" )
{
