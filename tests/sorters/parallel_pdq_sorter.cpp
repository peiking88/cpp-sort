...
TEST_CASE( "parallel_pdq_sorter tests", "[parallel_pdq_sorter]" )
{
    ...
    SECTION( "small dataset: sort with random-access range and compare" )
    {
        ...
        cppsort::parallel_pdq_sort(vec, std::greater{});
    ...
    SECTION( "small dataset: sort with random-access iterators" )
    {
        ...
        cppsort::parallel_pdq_sort(vec.begin(), vec.end());
        CHECK( std::is_sorted(vec.begin(), vec.end()) );
    }
    ...
    SECTION( "small dataset: sort with random-access iterators and compare" )
    {
        ...
        cppsort::parallel_pdq_sort(vec.begin(), vec.end(), std::greater{});
        CHECK( std::is_sorted(vec.begin(), vec.end(), std::greater{}) );
    }
...
TEST_CASE( "parallel_pdq_sorter large dataset tests", "[parallel_pdq_sorter][large]" )
{
